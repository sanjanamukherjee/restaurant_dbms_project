...
require('db.php');
$oid= $_SESSION['oid'];
$query= mysqli_query($con,"SELECT * FROM ORDER_ITEMS WHERE ORDER_ID= $oid");
...
<?php
$query1= mysqli_query($con,"SELECT * FROM ORDERS WHERE ORDER_ID= $oid");
...
<h2 style="font-family: cursive;">YOUR ORDER WILL BE DELIVERED TO YOU AT :</h2>
<h2><?php echo $row1['ADDRESS']; ?> </h2>
<?php echo "<h2> CONTACT: ".$row1['PH_NO']."</h2>"; ?>
