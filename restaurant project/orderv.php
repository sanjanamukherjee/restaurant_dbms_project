...
$query1= mysqli_query($con, "SELECT * FROM MENU WHERE TYPE= 'V'");
...
?>
	...
	<div id="myModal" class="modal">
		<div class="modal-content">
    		...
    		<form action="orderv.php" method="post">
    			...
    			<!--<input type="text" maxlength="255" class="form-control" name="address" placeholder="your address" required>-->
	...
	if(isset($_POST['okay'])){
					...
					$ADD=$_POST['address'];
					$PH=$_POST['phone'];
					$s3="UPDATE ORDERS SET ADDRESS= '$ADD', PH_NO= $PH WHERE ORDER_ID= $oid";
					//echo $s3;
	...
	if(isset($_POST['done']))
	
			{
				...
				foreach($_POST['select'] as $selected)
				{
					...
					$oid= $_SESSION['oid'];
					$s1="INSERT INTO ORDER_ITEMS (ORDER_ID, ITEMS, ITEM_PRICE) VALUES ($oid,'$row4[ITEM_NAME]',$row4[PRICE])";
					//echo $s1;
				...
				$oid= $_SESSION['oid'];
				$query6= mysqli_query($con,"UPDATE ORDERS SET TOT_AMT = $tot_amt WHERE ORDER_ID= $oid");
				}
